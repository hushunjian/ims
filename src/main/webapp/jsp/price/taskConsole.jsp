...
var runTask8 = function(){
	if(confirm("转换会消耗很长时间，确认要转换吗？")){
		$("#btnSearch8").attr("disabled",true);
		$.ajax({
			url : "${ctx}/task/transformKingdomInage",
			async : false,
			type : "GET",
			contentType : "application/json;charset=UTF-8",
			success : function(resp) {
				alert(resp);
				$("#btnSearch8").attr("disabled",false);
			}
		});
	}
}
		...
		<section id="main-content">
			<section class="wrapper">
					...
					<div class="row">
						<div class="col-lg-12">
							<section class="panel">
								<header class="panel-heading">转换王国图库图片</header>
								<div class="panel-body">
									<div class="form-inline" role="form">
										<input type="button" id="btnSearch8" name="btnSearch7" value="开始转换" onclick="runTask8()" class="btn btn-info" />
									</div>
								</div>
							</section>
						</div>
