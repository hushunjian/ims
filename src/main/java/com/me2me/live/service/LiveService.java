...
public interface LiveService {
     ...
     * @return
     */
    Response userLike(long uid,long data,int isLike,int type);
    /**
     * 举报标签。
     * @author zhangjiwei
     * @date Sep 1, 2017
	...
	void changeTopicKingNew(Topic updateTopic, long topicId);


	void updateContentByUidAndTopicIdAndType(long targetUid, long topicId, int i);
